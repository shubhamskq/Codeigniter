...
$route['us/'] = '/us/index';
$route['us/(:any)'] = '/us/index/docx_category/$1';
...
// default dynamic url 
if (strpos($_SERVER['REQUEST_URI'], 'lawyers-in') !== false) {
	$route['(:any)'] = 'find_lawyer/index/$1';
}

// when search by case category & city
if (strpos($_SERVER['REQUEST_URI'], '-lawyers/') !== false) {
	$route['(:any)/(:any)'] = 'find_lawyer/index/$1/$1';
}

// for detials page
if (strpos($_SERVER['REQUEST_URI'], 'advocate-') !== false) {
	$route['(:any)'] = 'find_lawyer_details/index/$1';
}
