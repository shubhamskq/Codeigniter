        ...
        <div class="container">
            <div class="row">
                                      ...
                                      <tr>
                                            <td colspan="2">
                                                <div class="box-cart mt-2">
                                                    <div class="box-head"><i class="bi bi-person"></i> Payment Status</div>
                                                    <form>
                                                        <div class="box-body row px-2">
                                                            <div class="col-md-11">
                                                                <label for="text">Payment Status Change</label><br>
                                                                <select class="form-control" name="status"
                                                                    id="paymnetstatus">
                                                                    <option value="1"
                                                                        <?php echo ($case_data->payment_status == 1)?'selected':''; ?>>
                                                                        Success</option>
                                                                    <option value="0"
                                                                        <?php echo ($case_data->payment_status == 0)?'selected':''; ?>>
                                                                        Pending</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <button type="submit" class="btn btn-primary ml-2 pay_status">Update Payment</button>
                                                    </form>
                                                </div>
                                            </td>
                                        </tr>
                                         <tr>
                                            <td colspan="2">
                                                <div class="box-cart mt-2">
                                                    <div class="box-head"><i class="bi bi-person"></i> Payment Status</div>
                                                    <form method="post" action="admin/case_details/updatestatus">
                                                        <div class="box-body row px-2">
                                                            <div class="col-md-11">
                                                                <label for="text">Payment Status Change</label><br>
                                                        ...
                                                        <button type="submit" class="btn btn-primary ml-2 checkform">Update Payment</button>
                                                    </form>
                                                </div>
                                            </td>
                                        </tr>
                ...
                <!-- Cancel meeting end-->
                 ...
                 <!-- Payment Link Generater-->
                <?php if(isset($payment_data->payment_status) && strtolower($payment_data->payment_status) != 'success'){
                ...
                <tr>
                    <td colspan="2">
                        <div class="box-cart mt-2">
                            <div class="box-head"><i class="bi bi-person"></i> Payment Link Generater </div>
                            <form>
                                <div class="box-body row px-2">
                                    <?php  ?>
                                    <div class="col-md-11">
                                        <label for="text">Payment Link : </label>

                                        <div class="d-flex flex-row">
                                        <div class=""><p><input type="text" value="<?= $payment_data->pay_link?>" id="myInput"></p></div>
                                        <div class="mb-2"><button onclick="myFunction()">Copy Link</button></div>
                                        </div>

                                        <label for="text">Add Payments</label><br>
                                        <?php if(!empty($payment_data)){?>
                                        <input type="text" class="payment_money"
                                            value="<?php echo $payment_data->amount; ?>" name="cancel_reason">
                                            <?php }?>
                                    </div>
                                </div>
                                <button type="submit" class="btn btn-primary ml-2 genereted_link">Genereted Links</button>
                            </form>
                            <form>
                                <div class="box-body row px-2">
                                    <?php  ?>
                                    <div class="col-md-11">
                                        ...
                                        <input class="form-check-input freemeet_val" type="checkbox" value="Free" id="flexCheckDefault">
                                        <label class="form-check-label" for="flexCheckDefault">
                                            Free Meeting
                                        </label><br>
                                        <label for="text">Comment/Payment Method</label><br>
                                        <input type="text" class="form-control comment_value "
                                            value="" name="Comment">
                                        </div>
                                        ...
                                        <?php if(!empty($payment_data)){
                                            ...
                                            ?>
                                            <select class="form-select" id="payStatus"  aria-label="Default select example">
                                ...
                                <button type="submit" class="btn btn-primary ml-2 freemeeting_link">ok</button>
                            </form>
                        </div>
...
$(document).ready(function() {
    ...
    $(".pay_status").click(function() {
        var case_id = "<?= $case_data->id?>";
        var pay_data = $('#paymnetstatus').find(":selected").text();
        var url = "<?php echo base_url('admin/Case_details/update_paymentstatus')?>";
        $.ajax({
            type: "POST",
            url: url,
            data: {
            ...
            success: function(responce) {
                if (responce == 1) {
                    alert("Paymentdata Status Updated successfully");
                    location.reload();
                    return false;
                }
            }
    ...
    $(".cancel_meeting").click(function() {
     ...
     // Genrate paymnet data script
    $(".genereted_link").click(function() {
        var case_id = "<?= $case_data->id?>";
        var paymentval = $(".payment_money").val();
        var url = "<?php echo base_url('admin/Case_details/genratedata')?>";
        $.ajax({
            type: "POST",
            url: url,
            data: {
            ...
            success: function(responce) {
                if (responce == 1) {
                    alert("Paymnet generated successfully");
                    location.reload();
                    return false;
                }
            }
   ...
   // Genrate paymnet data script end
  
   // free paymnet data script
   $(".freemeeting_link").click(function() {
        var case_id = "<?= $case_data->id?>";
        var commentval = $(".comment_value").val();
        var freemeetval=  ($('.freemeet_val').is(':checked'))?"Free":'';
        var payStatus=$("#payStatus").val();
    
       
        var url = "<?php echo base_url('admin/Case_details/freemeetdata')?>";
        $.ajax({
            type: "POST",
            url: url,
            data: {
